...
import { Sparkles, Brain, Clock, ShoppingCart } from "lucide-react";
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";
import { zeroOneKnapsack, KnapsackResult } from "@/utils/knapsack";
...
const Recommend = () => {
  ...
  const handleGetRecommendations = () => {
    ...
    setTimeout(() => {
      ...
      const algorithmResult = zeroOneKnapsack(filteredProducts, budgetNum);
            ...
            <Card className="max-w-4xl mx-auto p-6 bg-gradient-to-r from-primary/10 to-primary/5 border-primary/20">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-xl">0/1 Knapsack Algorithm Result</h3>
              ...
              >
                ...
                Add All {result.selectedProducts.length} Products to Cart
              </Button>
            </Card>
